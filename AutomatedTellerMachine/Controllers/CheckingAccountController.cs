...
namespace AutomatedTellerMachine.Controllers
{
    ...
    public class CheckingAccountController : Controller
    {
        ...
        public ActionResult Details()
        {
            ...
            CheckingAccount checkingAccount= db.CheckingAccounts.Where(c => c.ApplicationUserId == userId).First();
        ...
        {
            CheckingAccount checkingAccount = db.CheckingAccounts.Where(c => c.Id == id).First();
